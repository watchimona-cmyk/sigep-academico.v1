...
export const NAVIGATION_CONFIG: MenuItemConfig[] = [
  ...
  },
  {
    ...
    label: 'FINANÇAS',
    iconName: 'DollarSign',
    rolesAllowed: ['SIGEP', 'DIRECTOR_GERAL', 'SUB_DIRECTOR_ADMINISTRATIVO', 'CHEFE_SECRETARIA', 'TECNICO_ADMINISTRATIVO', 'COORDENADOR_TURNO', 'COORDENADOR_DISCIPLINA', 'COORDENADOR'],
  ...
  },
  {
    ...
    rolesAllowed: ['SIGEP', 'DIRECTOR_GERAL', 'SUB_DIRECTOR_PEDAGOGICO', 'SUB_DIRECTOR_ADMINISTRATIVO', 'CHEFE_SECRETARIA', 'TECNICO_PEDAGOGICO', 'TECNICO_ADMINISTRATIVO', 'PROFESSOR'],
